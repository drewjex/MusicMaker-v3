...
class RepeatRhythmsAllTracks extends Maker implements IMaker {
    ...
    public function make() {
        ...
        $rhythm_patterns = $this->music_generator->getSongRhythmicPatternsByIncrement($song, $increment, $similarity);
        $patterns = $this->music_generator->getSongPatternsByIncrement($song, $increment, $similarity);
        ...
        foreach ($rhythm_patterns as $rhythm_key => $object) {
            $rhythm_pieces = array();
            $pattern = $object->patterns; //the structure will be whatever, but THIS will be the same and correspond with all!
